...
mixin _$NotificationModel {
 ...
 String get id;@JsonKey(name: 'created_at') DateTime get createdAt; String? get mensagem; bool? get lido;@JsonKey(name: 'user_id') String? get userId; String? get assunto;@JsonKey(name: 'missao_id') String? get missionId;@JsonKey(name: 'post_id') String? get postId;@JsonKey(name: 'solicitacao_user_id') String? get solicitacaoUserId;@JsonKey(name: 'solicitacaorespondida') bool? get solicitacaoRespondida;@JsonKey(name: 'doc_id') String? get docId; String? get titulo; String? get icone;@JsonKey(name: 'grupo_id') String? get grupoId;@JsonKey(name: 'batepapo_id') String? get batepapoId;@JsonKey(name: 'target_route') String? get targetRoute;// Joined data from users table (if any)
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,createdAt,mensagem,lido,userId,assunto,missionId,postId,solicitacaoUserId,solicitacaoRespondida,docId,titulo,icone,grupoId,batepapoId,targetRoute,userName,userAvatar);

@override
String toString() {
  return 'NotificationModel(id: $id, createdAt: $createdAt, mensagem: $mensagem, lido: $lido, userId: $userId, assunto: $assunto, missionId: $missionId, postId: $postId, solicitacaoUserId: $solicitacaoUserId, solicitacaoRespondida: $solicitacaoRespondida, docId: $docId, titulo: $titulo, icone: $icone, grupoId: $grupoId, batepapoId: $batepapoId, targetRoute: $targetRoute, userName: $userName, userAvatar: $userAvatar)';
}
...
@useResult
$Res call({
 String id,@JsonKey(name: 'created_at') DateTime createdAt, String? mensagem, bool? lido,@JsonKey(name: 'user_id') String? userId, String? assunto,@JsonKey(name: 'missao_id') String? missionId,@JsonKey(name: 'post_id') String? postId,@JsonKey(name: 'solicitacao_user_id') String? solicitacaoUserId,@JsonKey(name: 'solicitacaorespondida') bool? solicitacaoRespondida,@JsonKey(name: 'doc_id') String? docId, String? titulo, String? icone,@JsonKey(name: 'grupo_id') String? grupoId,@JsonKey(name: 'batepapo_id') String? batepapoId,@JsonKey(name: 'target_route') String? targetRoute,@JsonKey(ignore: true) String? userName,@JsonKey(ignore: true) String? userAvatar
});
...
/// Create a copy of NotificationModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? createdAt = null,Object? mensagem = freezed,Object? lido = freezed,Object? userId = freezed,Object? assunto = freezed,Object? missionId = freezed,Object? postId = freezed,Object? solicitacaoUserId = freezed,Object? solicitacaoRespondida = freezed,Object? docId = freezed,Object? titulo = freezed,Object? icone = freezed,Object? grupoId = freezed,Object? batepapoId = freezed,Object? targetRoute = freezed,Object? userName = freezed,Object? userAvatar = freezed,}) {
...
as String?,targetRoute: freezed == targetRoute ? _self.targetRoute : targetRoute // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'created_at')  DateTime createdAt,  String? mensagem,  bool? lido, @JsonKey(name: 'user_id')  String? userId,  String? assunto, @JsonKey(name: 'missao_id')  String? missionId, @JsonKey(name: 'post_id')  String? postId, @JsonKey(name: 'solicitacao_user_id')  String? solicitacaoUserId, @JsonKey(name: 'solicitacaorespondida')  bool? solicitacaoRespondida, @JsonKey(name: 'doc_id')  String? docId,  String? titulo,  String? icone, @JsonKey(name: 'grupo_id')  String? grupoId, @JsonKey(name: 'batepapo_id')  String? batepapoId, @JsonKey(name: 'target_route')  String? targetRoute, @JsonKey(ignore: true)  String? userName, @JsonKey(ignore: true)  String? userAvatar)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NotificationModel() when $default != null:
return $default(_that.id,_that.createdAt,_that.mensagem,_that.lido,_that.userId,_that.assunto,_that.missionId,_that.postId,_that.solicitacaoUserId,_that.solicitacaoRespondida,_that.docId,_that.titulo,_that.icone,_that.grupoId,_that.batepapoId,_that.targetRoute,_that.userName,_that.userAvatar);case _:
  return orElse();
...
class _NotificationModel extends NotificationModel {
  const _NotificationModel({required this.id, @JsonKey(name: 'created_at') required this.createdAt, required this.mensagem, required this.lido, @JsonKey(name: 'user_id') required this.userId, this.assunto, @JsonKey(name: 'missao_id') this.missionId, @JsonKey(name: 'post_id') this.postId, @JsonKey(name: 'solicitacao_user_id') this.solicitacaoUserId, @JsonKey(name: 'solicitacaorespondida') this.solicitacaoRespondida, @JsonKey(name: 'doc_id') this.docId, this.titulo, this.icone, @JsonKey(name: 'grupo_id') this.grupoId, @JsonKey(name: 'batepapo_id') this.batepapoId, @JsonKey(name: 'target_route') this.targetRoute, @JsonKey(ignore: true) this.userName, @JsonKey(ignore: true) this.userAvatar}): super._();
...
@override@JsonKey(name: 'target_route') final  String? targetRoute;
