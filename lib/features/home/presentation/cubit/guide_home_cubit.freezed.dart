...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GuideHomeState);
}
...
/// @nodoc
class $GuideHomeStateCopyWith<$Res>  {
$GuideHomeStateCopyWith(GuideHomeState _, $Res Function(GuideHomeState) __);
}


/// Adds pattern-matching-related methods to [GuideHomeState].
extension GuideHomeStatePatterns on GuideHomeState {
...
class _Initial implements GuideHomeState {
  const _Initial();
...
class _Loading implements GuideHomeState {
  const _Loading();
...
class _Loaded implements GuideHomeState {
 ...
 List<GuideMission> get missions {
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $GuideHomeStateCopyWith<$Res> {
...
class _Error implements GuideHomeState {
...
@override
String toString() {
  return 'GuideHomeState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $GuideHomeStateCopyWith<$Res> {
