      ...
      (failure) {
        if (mounted) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text('${context.t('Erro ao carregar incidentes', 'Error loading incidents')}: ${failure.toString().replaceAll("Exception: ", "")}')),
          );
        }
      },
      (list) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text(
          context.t('Incidentes', 'Incidents'),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              context.t('Nenhum incidente registrado', 'No incidents recorded'),
            ...
            Text(
              context.t(
                ...
                'Tap the + button at the top to report an incident.',
              ),
        ...
        children: [
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            '$formattedDate ${context.t("às", "at")} $formattedTime',
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  '${context.t('Descrição', 'Description')}:',
                  style: AppTextStyles.bodySmall.copyWith(
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                Text(
                  '${context.t('Relatado por', 'Reported by')} $guideName',
                  style: AppTextStyles.bodySmall.copyWith(
                    fontSize: 12,
                    color: Colors.grey[500],
                  ),
  ...
  void _confirmDeleteIncident(String incidentId) {
    showModalBottomSheet<bool>(
      ...
      builder: (context) => CustomConfirmBottomSheet(
        title: context.t('Excluir incidente', 'Delete incident'),
        message: context.t(
          'Deseja realmente excluir este incidente? Esta ação não pode ser desfeita.',
          'Do you really want to delete this incident? This action cannot be undone.',
        ),
        ...
        result.fold(
          (failure) {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Text(
                  '${context.t('Erro ao excluir incidente', 'Error deleting incident')}: ${failure.toString().replaceAll("Exception: ", "")}',
                ),
              ),
            );
          },
          (_) {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Text(context.t('Incidente excluído com sucesso!', 'Incident deleted successfully!')),
              ),
            );
          },
        );
