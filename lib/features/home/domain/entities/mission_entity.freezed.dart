...
mixin _$MissionEntity {
 ...
 String get id; String get name; String? get logo; String? get location; DateTime? get startDate; DateTime? get endDate; String? get groupName; String? get groupLogo; int? get pendingDocsCount; String? get status; bool get passaporteObrigatorio; bool get vistoObrigatorio; bool get vacinaObrigatoria; bool get seguroObrigatorio; bool get carteiraObrigatoria; bool get autorizacaoObrigatoria;
...
@override
int get hashCode => Object.hash(runtimeType,id,name,logo,location,startDate,endDate,groupName,groupLogo,pendingDocsCount,status,passaporteObrigatorio,vistoObrigatorio,vacinaObrigatoria,seguroObrigatorio,carteiraObrigatoria,autorizacaoObrigatoria);

@override
String toString() {
  return 'MissionEntity(id: $id, name: $name, logo: $logo, location: $location, startDate: $startDate, endDate: $endDate, groupName: $groupName, groupLogo: $groupLogo, pendingDocsCount: $pendingDocsCount, status: $status, passaporteObrigatorio: $passaporteObrigatorio, vistoObrigatorio: $vistoObrigatorio, vacinaObrigatoria: $vacinaObrigatoria, seguroObrigatorio: $seguroObrigatorio, carteiraObrigatoria: $carteiraObrigatoria, autorizacaoObrigatoria: $autorizacaoObrigatoria)';
}
...
@useResult
$Res call({
 String id, String name, String? logo, String? location, DateTime? startDate, DateTime? endDate, String? groupName, String? groupLogo, int? pendingDocsCount, String? status, bool passaporteObrigatorio, bool vistoObrigatorio, bool vacinaObrigatoria, bool seguroObrigatorio, bool carteiraObrigatoria, bool autorizacaoObrigatoria
});
...
/// Create a copy of MissionEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? logo = freezed,Object? location = freezed,Object? startDate = freezed,Object? endDate = freezed,Object? groupName = freezed,Object? groupLogo = freezed,Object? pendingDocsCount = freezed,Object? status = freezed,Object? passaporteObrigatorio = null,Object? vistoObrigatorio = null,Object? vacinaObrigatoria = null,Object? seguroObrigatorio = null,Object? carteiraObrigatoria = null,Object? autorizacaoObrigatoria = null,}) {
...
as String?,passaporteObrigatorio: null == passaporteObrigatorio ? _self.passaporteObrigatorio : passaporteObrigatorio // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String? logo,  String? location,  DateTime? startDate,  DateTime? endDate,  String? groupName,  String? groupLogo,  int? pendingDocsCount,  String? status,  bool passaporteObrigatorio,  bool vistoObrigatorio,  bool vacinaObrigatoria,  bool seguroObrigatorio,  bool carteiraObrigatoria,  bool autorizacaoObrigatoria)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MissionEntity() when $default != null:
return $default(_that.id,_that.name,_that.logo,_that.location,_that.startDate,_that.endDate,_that.groupName,_that.groupLogo,_that.pendingDocsCount,_that.status,_that.passaporteObrigatorio,_that.vistoObrigatorio,_that.vacinaObrigatoria,_that.seguroObrigatorio,_that.carteiraObrigatoria,_that.autorizacaoObrigatoria);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String? logo,  String? location,  DateTime? startDate,  DateTime? endDate,  String? groupName,  String? groupLogo,  int? pendingDocsCount,  String? status,  bool passaporteObrigatorio,  bool vistoObrigatorio,  bool vacinaObrigatoria,  bool seguroObrigatorio,  bool carteiraObrigatoria,  bool autorizacaoObrigatoria)  $default,) {final _that = this;
switch (_that) {
case _MissionEntity():
return $default(_that.id,_that.name,_that.logo,_that.location,_that.startDate,_that.endDate,_that.groupName,_that.groupLogo,_that.pendingDocsCount,_that.status,_that.passaporteObrigatorio,_that.vistoObrigatorio,_that.vacinaObrigatoria,_that.seguroObrigatorio,_that.carteiraObrigatoria,_that.autorizacaoObrigatoria);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String? logo,  String? location,  DateTime? startDate,  DateTime? endDate,  String? groupName,  String? groupLogo,  int? pendingDocsCount,  String? status,  bool passaporteObrigatorio,  bool vistoObrigatorio,  bool vacinaObrigatoria,  bool seguroObrigatorio,  bool carteiraObrigatoria,  bool autorizacaoObrigatoria)?  $default,) {final _that = this;
switch (_that) {
case _MissionEntity() when $default != null:
return $default(_that.id,_that.name,_that.logo,_that.location,_that.startDate,_that.endDate,_that.groupName,_that.groupLogo,_that.pendingDocsCount,_that.status,_that.passaporteObrigatorio,_that.vistoObrigatorio,_that.vacinaObrigatoria,_that.seguroObrigatorio,_that.carteiraObrigatoria,_that.autorizacaoObrigatoria);case _:
  return null;
...
class _MissionEntity extends MissionEntity {
  const _MissionEntity({required this.id, required this.name, this.logo, this.location, this.startDate, this.endDate, this.groupName, this.groupLogo, this.pendingDocsCount, this.status, this.passaporteObrigatorio = false, this.vistoObrigatorio = false, this.vacinaObrigatoria = false, this.seguroObrigatorio = false, this.carteiraObrigatoria = false, this.autorizacaoObrigatoria = false}): super._();
