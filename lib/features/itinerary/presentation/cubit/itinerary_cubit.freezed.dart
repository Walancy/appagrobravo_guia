...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ItineraryState);
}
...
/// @nodoc
class $ItineraryStateCopyWith<$Res>  {
$ItineraryStateCopyWith(ItineraryState _, $Res Function(ItineraryState) __);
}


/// Adds pattern-matching-related methods to [ItineraryState].
extension ItineraryStatePatterns on ItineraryState {
...
class _Loaded implements ItineraryState {
 ...
 final  List<ItineraryItemEntity> _items;
 List<ItineraryItemEntity> get items {
 ...
 List<String> get pendingDocs {
  if (_pendingDocs is EqualUnmodifiableListView) return _pendingDocs;
  // ignore: implicit_dynamic_type
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $ItineraryStateCopyWith<$Res> {
...
$ItineraryGroupEntityCopyWith<$Res> get group;
...
$ItineraryGroupEntityCopyWith<$Res> get group {
  ...
  return $ItineraryGroupEntityCopyWith<$Res>(_self.group, (value) {
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $ItineraryStateCopyWith<$Res> {
