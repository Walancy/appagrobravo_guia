...
@override
int get hashCode => Object.hashAll([runtimeType,id,name,avatarUrl,coverUrl,jobTitle,bio,missionName,email,phone,cpf,ssn,zipCode,state,city,street,number,neighborhood,complement,birthDate,nationality,passport,const DeepCollectionEquality().hash(foodPreferences),const DeepCollectionEquality().hash(medicalRestrictions),connectionsCount,postsCount,missionsCount,isGuide,connectionStatus]);

@override
String toString() {
  return 'ProfileEntity(id: $id, name: $name, avatarUrl: $avatarUrl, coverUrl: $coverUrl, jobTitle: $jobTitle, bio: $bio, missionName: $missionName, email: $email, phone: $phone, cpf: $cpf, ssn: $ssn, zipCode: $zipCode, state: $state, city: $city, street: $street, number: $number, neighborhood: $neighborhood, complement: $complement, birthDate: $birthDate, nationality: $nationality, passport: $passport, foodPreferences: $foodPreferences, medicalRestrictions: $medicalRestrictions, connectionsCount: $connectionsCount, postsCount: $postsCount, missionsCount: $missionsCount, isGuide: $isGuide, connectionStatus: $connectionStatus)';
}
...
switch (_that) {
case _ProfileEntity() when $default != null:
return $default(_that.id,_that.name,_that.avatarUrl,_that.coverUrl,_that.jobTitle,_that.bio,_that.missionName,_that.email,_that.phone,_that.cpf,_that.ssn,_that.zipCode,_that.state,_that.city,_that.street,_that.number,_that.neighborhood,_that.complement,_that.birthDate,_that.nationality,_that.passport,_that.foodPreferences,_that.medicalRestrictions,_that.connectionsCount,_that.postsCount,_that.missionsCount,_that.isGuide,_that.connectionStatus);case _:
  return orElse();
...
class _ProfileEntity extends ProfileEntity {
  const _ProfileEntity({required this.id, required this.name, required this.avatarUrl, required this.coverUrl, required this.jobTitle, required this.bio, required this.missionName, required this.email, required this.phone, required this.cpf, required this.ssn, required this.zipCode, required this.state, required this.city, required this.street, required this.number, required this.neighborhood, required this.complement, required this.birthDate, required this.nationality, required this.passport, required final  List<String>? foodPreferences, required final  List<String>? medicalRestrictions, required this.connectionsCount, required this.postsCount, required this.missionsCount, required this.isGuide, this.connectionStatus = ConnectionStatus.none}): _foodPreferences = foodPreferences,_medicalRestrictions = medicalRestrictions,super._();
...
@override
int get hashCode => Object.hashAll([runtimeType,id,name,avatarUrl,coverUrl,jobTitle,bio,missionName,email,phone,cpf,ssn,zipCode,state,city,street,number,neighborhood,complement,birthDate,nationality,passport,const DeepCollectionEquality().hash(_foodPreferences),const DeepCollectionEquality().hash(_medicalRestrictions),connectionsCount,postsCount,missionsCount,isGuide,connectionStatus]);
