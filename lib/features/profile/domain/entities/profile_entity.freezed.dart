...
mixin _$ProfileEntity {
 ...
 String get id; String get name; String? get avatarUrl; String? get coverUrl; String? get jobTitle; String? get bio; String? get missionName; String? get email; String? get phone; String? get cpf; String? get ssn; String? get zipCode; String? get state; String? get city; String? get street; String? get number; String? get neighborhood; String? get complement; DateTime? get birthDate; String? get nationality; String? get passport; List<String>? get foodPreferences; List<String>? get medicalRestrictions; int get connectionsCount; int get postsCount; int get missionsCount; bool get isGuide; String? get company; String? get country; String? get badgeName; String? get emergencyName; String? get emergencyRelationship; String? get emergencyContact; ConnectionStatus get connectionStatus;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ProfileEntity&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.avatarUrl, avatarUrl) || other.avatarUrl == avatarUrl)&&(identical(other.coverUrl, coverUrl) || other.coverUrl == coverUrl)&&(identical(other.jobTitle, jobTitle) || other.jobTitle == jobTitle)&&(identical(other.bio, bio) || other.bio == bio)&&(identical(other.missionName, missionName) || other.missionName == missionName)&&(identical(other.email, email) || other.email == email)&&(identical(other.phone, phone) || other.phone == phone)&&(identical(other.cpf, cpf) || other.cpf == cpf)&&(identical(other.ssn, ssn) || other.ssn == ssn)&&(identical(other.zipCode, zipCode) || other.zipCode == zipCode)&&(identical(other.state, state) || other.state == state)&&(identical(other.city, city) || other.city == city)&&(identical(other.street, street) || other.street == street)&&(identical(other.number, number) || other.number == number)&&(identical(other.neighborhood, neighborhood) || other.neighborhood == neighborhood)&&(identical(other.complement, complement) || other.complement == complement)&&(identical(other.birthDate, birthDate) || other.birthDate == birthDate)&&(identical(other.nationality, nationality) || other.nationality == nationality)&&(identical(other.passport, passport) || other.passport == passport)&&const DeepCollectionEquality().equals(other.foodPreferences, foodPreferences)&&const DeepCollectionEquality().equals(other.medicalRestrictions, medicalRestrictions)&&(identical(other.connectionsCount, connectionsCount) || other.connectionsCount == connectionsCount)&&(identical(other.postsCount, postsCount) || other.postsCount == postsCount)&&(identical(other.missionsCount, missionsCount) || other.missionsCount == missionsCount)&&(identical(other.isGuide, isGuide) || other.isGuide == isGuide)&&(identical(other.company, company) || other.company == company)&&(identical(other.country, country) || other.country == country)&&(identical(other.badgeName, badgeName) || other.badgeName == badgeName)&&(identical(other.emergencyName, emergencyName) || other.emergencyName == emergencyName)&&(identical(other.emergencyRelationship, emergencyRelationship) || other.emergencyRelationship == emergencyRelationship)&&(identical(other.emergencyContact, emergencyContact) || other.emergencyContact == emergencyContact)&&(identical(other.connectionStatus, connectionStatus) || other.connectionStatus == connectionStatus));
}


@override
int get hashCode => Object.hashAll([runtimeType,id,name,avatarUrl,coverUrl,jobTitle,bio,missionName,email,phone,cpf,ssn,zipCode,state,city,street,number,neighborhood,complement,birthDate,nationality,passport,const DeepCollectionEquality().hash(foodPreferences),const DeepCollectionEquality().hash(medicalRestrictions),connectionsCount,postsCount,missionsCount,isGuide,company,country,badgeName,emergencyName,emergencyRelationship,emergencyContact,connectionStatus]);

@override
String toString() {
  return 'ProfileEntity(id: $id, name: $name, avatarUrl: $avatarUrl, coverUrl: $coverUrl, jobTitle: $jobTitle, bio: $bio, missionName: $missionName, email: $email, phone: $phone, cpf: $cpf, ssn: $ssn, zipCode: $zipCode, state: $state, city: $city, street: $street, number: $number, neighborhood: $neighborhood, complement: $complement, birthDate: $birthDate, nationality: $nationality, passport: $passport, foodPreferences: $foodPreferences, medicalRestrictions: $medicalRestrictions, connectionsCount: $connectionsCount, postsCount: $postsCount, missionsCount: $missionsCount, isGuide: $isGuide, company: $company, country: $country, badgeName: $badgeName, emergencyName: $emergencyName, emergencyRelationship: $emergencyRelationship, emergencyContact: $emergencyContact, connectionStatus: $connectionStatus)';
}
...
@useResult
$Res call({
 String id, String name, String? avatarUrl, String? coverUrl, String? jobTitle, String? bio, String? missionName, String? email, String? phone, String? cpf, String? ssn, String? zipCode, String? state, String? city, String? street, String? number, String? neighborhood, String? complement, DateTime? birthDate, String? nationality, String? passport, List<String>? foodPreferences, List<String>? medicalRestrictions, int connectionsCount, int postsCount, int missionsCount, bool isGuide, String? company, String? country, String? badgeName, String? emergencyName, String? emergencyRelationship, String? emergencyContact, ConnectionStatus connectionStatus
});
...
/// Create a copy of ProfileEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? avatarUrl = freezed,Object? coverUrl = freezed,Object? jobTitle = freezed,Object? bio = freezed,Object? missionName = freezed,Object? email = freezed,Object? phone = freezed,Object? cpf = freezed,Object? ssn = freezed,Object? zipCode = freezed,Object? state = freezed,Object? city = freezed,Object? street = freezed,Object? number = freezed,Object? neighborhood = freezed,Object? complement = freezed,Object? birthDate = freezed,Object? nationality = freezed,Object? passport = freezed,Object? foodPreferences = freezed,Object? medicalRestrictions = freezed,Object? connectionsCount = null,Object? postsCount = null,Object? missionsCount = null,Object? isGuide = null,Object? company = freezed,Object? country = freezed,Object? badgeName = freezed,Object? emergencyName = freezed,Object? emergencyRelationship = freezed,Object? emergencyContact = freezed,Object? connectionStatus = null,}) {
...
as int,isGuide: null == isGuide ? _self.isGuide : isGuide // ignore: cast_nullable_to_non_nullable
as bool,company: freezed == company ? _self.company : company // ignore: cast_nullable_to_non_nullable
as String?,country: freezed == country ? _self.country : country // ignore: cast_nullable_to_non_nullable
as String?,badgeName: freezed == badgeName ? _self.badgeName : badgeName // ignore: cast_nullable_to_non_nullable
as String?,emergencyName: freezed == emergencyName ? _self.emergencyName : emergencyName // ignore: cast_nullable_to_non_nullable
as String?,emergencyRelationship: freezed == emergencyRelationship ? _self.emergencyRelationship : emergencyRelationship // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String? avatarUrl,  String? coverUrl,  String? jobTitle,  String? bio,  String? missionName,  String? email,  String? phone,  String? cpf,  String? ssn,  String? zipCode,  String? state,  String? city,  String? street,  String? number,  String? neighborhood,  String? complement,  DateTime? birthDate,  String? nationality,  String? passport,  List<String>? foodPreferences,  List<String>? medicalRestrictions,  int connectionsCount,  int postsCount,  int missionsCount,  bool isGuide,  String? company,  String? country,  String? badgeName,  String? emergencyName,  String? emergencyRelationship,  String? emergencyContact,  ConnectionStatus connectionStatus)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProfileEntity() when $default != null:
return $default(_that.id,_that.name,_that.avatarUrl,_that.coverUrl,_that.jobTitle,_that.bio,_that.missionName,_that.email,_that.phone,_that.cpf,_that.ssn,_that.zipCode,_that.state,_that.city,_that.street,_that.number,_that.neighborhood,_that.complement,_that.birthDate,_that.nationality,_that.passport,_that.foodPreferences,_that.medicalRestrictions,_that.connectionsCount,_that.postsCount,_that.missionsCount,_that.isGuide,_that.company,_that.country,_that.badgeName,_that.emergencyName,_that.emergencyRelationship,_that.emergencyContact,_that.connectionStatus);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String? avatarUrl,  String? coverUrl,  String? jobTitle,  String? bio,  String? missionName,  String? email,  String? phone,  String? cpf,  String? ssn,  String? zipCode,  String? state,  String? city,  String? street,  String? number,  String? neighborhood,  String? complement,  DateTime? birthDate,  String? nationality,  String? passport,  List<String>? foodPreferences,  List<String>? medicalRestrictions,  int connectionsCount,  int postsCount,  int missionsCount,  bool isGuide,  String? company,  String? country,  String? badgeName,  String? emergencyName,  String? emergencyRelationship,  String? emergencyContact,  ConnectionStatus connectionStatus)  $default,) {final _that = this;
switch (_that) {
case _ProfileEntity():
return $default(_that.id,_that.name,_that.avatarUrl,_that.coverUrl,_that.jobTitle,_that.bio,_that.missionName,_that.email,_that.phone,_that.cpf,_that.ssn,_that.zipCode,_that.state,_that.city,_that.street,_that.number,_that.neighborhood,_that.complement,_that.birthDate,_that.nationality,_that.passport,_that.foodPreferences,_that.medicalRestrictions,_that.connectionsCount,_that.postsCount,_that.missionsCount,_that.isGuide,_that.company,_that.country,_that.badgeName,_that.emergencyName,_that.emergencyRelationship,_that.emergencyContact,_that.connectionStatus);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String? avatarUrl,  String? coverUrl,  String? jobTitle,  String? bio,  String? missionName,  String? email,  String? phone,  String? cpf,  String? ssn,  String? zipCode,  String? state,  String? city,  String? street,  String? number,  String? neighborhood,  String? complement,  DateTime? birthDate,  String? nationality,  String? passport,  List<String>? foodPreferences,  List<String>? medicalRestrictions,  int connectionsCount,  int postsCount,  int missionsCount,  bool isGuide,  String? company,  String? country,  String? badgeName,  String? emergencyName,  String? emergencyRelationship,  String? emergencyContact,  ConnectionStatus connectionStatus)?  $default,) {final _that = this;
switch (_that) {
case _ProfileEntity() when $default != null:
return $default(_that.id,_that.name,_that.avatarUrl,_that.coverUrl,_that.jobTitle,_that.bio,_that.missionName,_that.email,_that.phone,_that.cpf,_that.ssn,_that.zipCode,_that.state,_that.city,_that.street,_that.number,_that.neighborhood,_that.complement,_that.birthDate,_that.nationality,_that.passport,_that.foodPreferences,_that.medicalRestrictions,_that.connectionsCount,_that.postsCount,_that.missionsCount,_that.isGuide,_that.company,_that.country,_that.badgeName,_that.emergencyName,_that.emergencyRelationship,_that.emergencyContact,_that.connectionStatus);case _:
  return null;
...
class _ProfileEntity extends ProfileEntity {
  const _ProfileEntity({required this.id, required this.name, required this.avatarUrl, required this.coverUrl, required this.jobTitle, required this.bio, required this.missionName, required this.email, required this.phone, required this.cpf, required this.ssn, required this.zipCode, required this.state, required this.city, required this.street, required this.number, required this.neighborhood, required this.complement, required this.birthDate, required this.nationality, required this.passport, required final  List<String>? foodPreferences, required final  List<String>? medicalRestrictions, required this.connectionsCount, required this.postsCount, required this.missionsCount, required this.isGuide, this.company, this.country, this.badgeName, this.emergencyName, this.emergencyRelationship, this.emergencyContact, this.connectionStatus = ConnectionStatus.none}): _foodPreferences = foodPreferences,_medicalRestrictions = medicalRestrictions,super._();
...
@override final  String? emergencyName;
@override final  String? emergencyRelationship;
...
@override
int get hashCode => Object.hashAll([runtimeType,id,name,avatarUrl,coverUrl,jobTitle,bio,missionName,email,phone,cpf,ssn,zipCode,state,city,street,number,neighborhood,complement,birthDate,nationality,passport,const DeepCollectionEquality().hash(_foodPreferences),const DeepCollectionEquality().hash(_medicalRestrictions),connectionsCount,postsCount,missionsCount,isGuide,company,country,badgeName,emergencyName,emergencyRelationship,emergencyContact,connectionStatus]);
